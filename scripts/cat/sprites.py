...
for x in [
    ...
    'skin', 'skinextra',
    'scars', 'Newscars', 'scarsdark', 'scarsextra', 'Newscarsextra', 'scarsdarkextra',
    'eyes', 'eyes2', 'eyes_df', 'eyesextra', 'eyes2extra', 'eyesextra_df',
    'medcatherbs', 'medcatherbsextra',
    'collars', 'bowcollars','bellcollars', 'collarsextra', 'bowcollarsextra', 'bellcollarsextra',
    'whitepatches', 'whitepatches3', 'whitepatches4', 'whiteextra', 'whitepatches3extra', 'whitepatches4extra',
    'whitepatchesnew', 'whitenewextra',
    ...
    'tortiecolourssolid', 'tortiecoloursmarbled', 'tortiecoloursticked', 'tortiecoloursrosette',
    'tortiecoloursspeckled', 'tortiecoloursmackerel', 'tortiecoloursclassic', 'tortiecoloursagouti',
    'tortiesextrasolid', 'tortiesextramarbled', 'tortiesextraticked', 'tortiesextrarosette', 'tortiesextraspeckled',
    'tortiesextramackerel', 'tortiesextraclassic', 'tortiesextraagouti'
